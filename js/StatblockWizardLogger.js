...
function demodata() {
    ...
    *{margin:0;padding:0;}
    ...
    <div class="StatblockWizard-section StatblockWizard-specialtraits"><p class="StatblockWizard-line StatblockWizard-namedstring"><span class="StatblockWizard-keyword">StatblockWizard SVG file analyzer.</span><span>The logger knows how to read StatblockWizard SVG files. Sections of the embedded statblock will become selectable, and when selected the keyword for that action will be added as an event in the Log.</span></p>
    </div>
